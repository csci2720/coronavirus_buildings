...
export default function Table2(props) {
    ...
    //     localStorage.setItem('covidData', JSON.stringify(props.data))
    ...
    if (true) {
        return (
            <div style={{ margin: '30px', marginTop: '70px', width: '800px' }}>
                                    ...
                                    return (
                                        <TableRow hover role="checkbox" tabIndex={-1} key={row.code}>
                                            ...
                                            <div style={{ display: 'flex', flexDirection: 'row' }}>
                                                ...
                                                <Button variant="outlined" color="primary" style={{ height: '37px', fontSize: '8px', margin: '20px' }} >Add To Favourites</Button>
